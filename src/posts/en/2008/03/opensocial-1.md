...
---
I tried running my own app on Orkut and MySpace, so here is my report.
...
It would be endless to delve into the specifications of GoogleGadget itself, so I'll stop here. For more details, please see the [Reference](http://code.google.com/intl/ja/apis/gadgets/docs/reference.html).
...
That's all for the first installment for now.
