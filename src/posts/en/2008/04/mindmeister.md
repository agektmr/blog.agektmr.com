...
However, the problem is FreeMind's speed. The Mac OS X version takes several minutes to start up even on a MacBook with a Core2Duo (version 0.8.1 or later?), and recently I've been struggling to even start it up. Then, [MindMeister](http://www.mindmeister.com/) released version 2.
