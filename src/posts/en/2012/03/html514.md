...
And [the API](http://api.html5please.com/). By embedding the widget created here on your own site, you can easily create a UI that notifies you when there are unsupported features. Browser support information is always up to date by using [caniuse.com](http://caniuse.com/).
...
This site allows users to create and share various JavaScript test cases. [Existing test cases](http://jsperf.com/browse) are useful for reference. Browser comparisons are also available using [Browserscope.org](http://www.browserscope.org/).
