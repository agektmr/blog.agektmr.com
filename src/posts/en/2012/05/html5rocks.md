...
### [Reading a file using the File API in JavaScript](http://www.html5rocks.com/ja/tutorials/file/dndfiles/)

A getting started guide to working with and reading binary files in JavaScript using the File / FileList / FileReader APIs.

### [Native HTML5 Drag and Drop](http://www.html5rocks.com/ja/tutorials/dnd/basics/)
...
### [Learn about the File System API](http://www.html5rocks.com/ja/tutorials/file/filesystem/)
...
And actually (and this is the main point), HTML5Rocks is looking for Japanese translations of articles. As is generally the case with documents that are translated into multiple languages, the reality is that it is extremely difficult to keep translations up to date. That's why HTML5Rocks is taking advantage of the fact that it is open source and is accepting translations from everyone. We have already received contributions from people such as [@kuu](http://github.com/kuu), [@ukyo](http://github.com/ukyo), [@Layzie](http://github.com/Layzie), [@pikotea](http://github.com/pikotea), and [@iizukak](https://github.com/iizukak), but we still have a long way to go on newer articles.

If you are even slightly interested, please first read the [Style Guide](http://www.html5rocks.com/en/style-guide) and, if you have actually translated something, please send us a pull request. Also, the design has recently changed, and it is now possible to include credits for translators. Please refer to the Translations section of the Style Guide and enter your name.
...
If you have any questions, feel free to contact us on [Google+](http://google.com/+agektmr) or [Twitter](http://twitter.com/agektmr). We look forward to your contributions!