...
Hackathon is a portmanteau of "hack" and "marathon," and participants are divided into groups and create software by coding on the spot.

This has been held several times in the past, mainly by Google, but this time we will be using <a target="_blank" href="http://sandbox.home.goo.ne.jp/">goo Home Sandbox</a> as a container.

* * *

Organizers: goo Home, Recruit Media Technology Lab, OpenSocial-Japan Community
Date and Time: Friday, April 24, 2009, 10:00 AM - 6:00 PM (Doors open at 9:30 AM)
Location: Recruit Media Technology Lab
Participants: 35
Requirements:

* People interested in OpenSocial
* People with JavaScript programming experience
* People with experience developing OpenSocial gadgets
(The tutorial below will help you understand the process more easily.)
...
If you would like to participate, please register at the following two sites:

<a target="_blank" href="http://atnd.org/events/472">http://atnd.org/events/472__HTML_TAG_12__

<a target="_blank" href="http://groups.google.com/group/opensocial-hackathon-0424">http://groups.google.com/group/opensocial-hackathon-0424__HTML_TAG_14__
↑Please read the details listed here carefully.
