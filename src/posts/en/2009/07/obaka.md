...
Well, I didn't do anything in the development process.

Due to some common issues that arise during a live demo, we ended up using the mixi app instead of the goo home sandbox we had planned to use for the demo, which meant we didn't get a chance to show off the various things that weboo had prepared, which was a bit disappointing.
